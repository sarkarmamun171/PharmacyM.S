    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-layout-text-window-reverse"></i><span>Medicines Stock</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="{{ route('medicine.stock.add') }}">
              <i class="bi bi-circle"></i><span>Medicine Stock Add</span>
            </a>
          </li>
          <li>
            <a href="{{ route('medicine.stock.list') }}">
              <i class="bi bi-circle"></i><span>Medicine Stock List</span>
            </a>
          </li>
        </ul>
      </li><!-- End Tables Nav -->
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="ri-admin-fill"></i><span>Suppliers</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
